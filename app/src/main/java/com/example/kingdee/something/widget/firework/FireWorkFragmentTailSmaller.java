...
public class FireWorkFragmentTailSmaller {
    ...
    public FireWorkFragmentTailSmaller(int radius,double lastX, double x, double lastY, double y, double sinValue, double cosValue, int red, int green, int blue){
        this.red=red;
        this.green=green;
        this.blue=blue;
