 ...
 *
 */
public class WaveViewOther extends View {
     ...
     * @param context
     */
    public WaveViewOther(Context context) {
        super(context);
     ...
     * @param attrs
     */
    public WaveViewOther(Context context, AttributeSet attrs) {
        super(context, attrs);
        // TODO Auto-generated constructor stub
        mContext = context;
        init(mContext);
     ...
     * @param defStyleAttr
     */
    public WaveViewOther(Context context, AttributeSet attrs, int defStyleAttr) {
